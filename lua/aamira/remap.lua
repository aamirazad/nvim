...
vim.keymap.set("n", "<leader>cc", "<cmd>w<CR><cmd>vsplit term://gcc % -lcs50<CR>")
vim.keymap.set("n", "<leader>cr", "<cmd>vsplit term://./a.out<CR>")
vim.keymap.set("n", "<leader>tm", "<cmd>vsplit<CR><cmd>terminal<CR>")
